...
if (! -r $config{'geoserver_config'}) {
	&ui_print_header(undef, $text{'index_title'}, "", "intro", 1, 1);
	print &text('index_econfig', "<tt>$config{'geoserver_config'}</tt>",
...
&ui_print_header("GeoServer<sup>&copy</sup> by <a href='https://www.acugis.com' target='blank'>AcuGIS</a>.  Cited, Inc. 2023 ", $text{'index_title'}, "", "intro", 1, 1, 0,
...
push(@links, 'http://'.$ENV{'SERVER_NAME'}.'/mapstore');
push(@titles, $text{'mapstore_title'});
push(@icons, "images/mapstoreimg.png");
