...
GeoSuite includes a shp2pgsql tool that can used to load shape files into PostGIS via Webmin.
...
.. code-block:: console
   ...
   root@geosuite:~# apt install postgis
...
.. code-block:: console
   ...
   root@geosuite:~# yum install postgis3_utils
