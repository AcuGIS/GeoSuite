=head1 geosuite-lib.pl

Functions for managing OpenGeo tasks.

  foreign_require("geosuite", "geosuite-lib.pl");
  @sites = geosuite::list_geosuite_websites()
...
sub get_geosuite_config
{
my $lref = &read_file_lines($config{'geosuite_conf'});
my @rv;
my $lnum = 0;
