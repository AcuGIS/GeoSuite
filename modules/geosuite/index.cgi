...
if (! -r $config{'geosuite_config'}) {
	&ui_print_header(undef, $text{'index_title'}, "", "intro", 1, 1);
	print &text('index_econfig', "<tt>$config{'geosuite_config'}</tt>",
...
&ui_print_header("GeoSuite<sup>&copy</sup> by <a href='https://www.acugis.com' target='blank'>AcuGIS</a>.  Cited, Inc. 2018 ", $text{'index_title'}, "", "intro", 1, 1, 0,
